...
export class AppLayoutComponent implements OnDestroy {
    ...
    constructor(
      private menuService: MenuService, public layoutService: LayoutService, public renderer: Renderer2, public router: Router) {
  ...
  ngOnInit(): void {
    // this.eventBus.onV1(RECEIVEMESSAGE2_EVENT_ID).subscribe({
    //   next:(args:any)=>{
    //           //TODO on receive message
    //     console.error('msg success')
    //     console.error('msg',args);
    //     console.error('msg',args.data[1]);
    //     let tmp = JSON.parse(args.data[1]);
    //     this.isMeet = !!tmp.msg;
    //     // args.data[1]?this.isMeet=true:this.isMeet=false
    //     console.log(tmp.msg);
    //     this.linkMeet=   tmp.msg;

    //     console.error('tmp',args) ;
