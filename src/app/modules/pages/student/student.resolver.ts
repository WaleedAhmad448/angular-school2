...
// import { ApiService } from 'src/app/core/service/api.service'; // ✅ استيراد ApiService
...
// //     const apiService = inject(ApiService); // ✅ استخدام ApiService

// //     // تهيئة ApiService مع module = 'students' و entity = ''
// //     apiService._initService(ModulesNames.Student, EntitiesNames.Student);

// export const StudentResolver: ResolveFn<PageListOptions> = (route, state) => {
//   const ctxService = inject(ContextService);
//   const studentService = inject(StudentService); // ✅ استخدام StudentService

//   // جلب البيانات
//   studentService.getStudents().subscribe((students) => {
//     console.log('Students:', students); // ✅ البيانات المسترجعة
//   });
...
//         fields: formFields,
//         saveDataType: 'formData', // ✅ إرسال البيانات كـ FormData
//         updateDataType: 'formData', // ✅ إرسال البيانات كـ FormData
//         type: 'dialog',
//         dialogOptions: {
